...
/** 정식 입찰 서비스의 락 재시도와 커밋 후 알림을 조정한다. */
@Service
@Slf4j
public class BidService implements BidUseCase {
    ...
    private final BidTransactionService transactionService;
    ...
    public BidService(
            ...
            BidTransactionService transactionService,
    ...
    private void publishCommittedBid(PlaceBidCommand command, PlaceBidResult result) {
        try {
            ...
            log.error("입찰 커밋 후 WebSocket 발행 실패 - 경매: {}, 입찰ID: {}",
