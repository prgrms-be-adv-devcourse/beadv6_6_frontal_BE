...
- HTTP 정식 계약은 `BidController`, `PlaceBidRequest/Response`로 승격하고 `/api/v2/...` 경로는 유지한다.
- v1 호환 코드는 `BidV1CompatibilityController`, `LegacyPlaceBidRequest/Response`로 명시해 정식 구현과 구분한다.
